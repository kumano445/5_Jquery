...
//id=q1のものに対し、.cssはCSS値を取得or書き換える。"color"は文字の色、"green"は文字の色を緑に変える。
  ...
  $("#q6").on("click", function() {
    ...
    $(this).animate(
      ...
      20000
      // thisはidを取得しているので、q6のことになる。q6クリックすると上が100px、左に100pxの間隔をあけながらアニメーションで2秒かけて動く。animateは特定のHTML要素のCSSプロパティを連続して変化させることでアニメーションを実現する。クリックすると"margin-top": 100,と"margin-left": 100の間隔が開くような動きをする。2E3は2X10の3乗になるため2000になる。20000は2秒を表すため2秒かけて"margin-top": 100,と"margin-left": 100の間隔が開くような動きをする。
    );
  });

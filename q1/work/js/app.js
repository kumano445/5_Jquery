$(function() {
  ...
  //id=q1のものに対し、.cssはCSS値を取得or書き換える。"color"は文字の色、"green"は文字の色を緑に変える。
    ...
    $("#q5").on("click", function() {
        ...
        $(this).prepend("DOM" + "の中の前").append
        ("DOM" + "の中の後").before("DOM" + "の前").after
        ("DOM" + "の後")
    ...
    $("#q10 li").on("click", function() {
        ...
        var a = $(this).index();
        // varは変数。aという変数を宣言し、$(this).index();を代入している。
        ...
        // 「eq()」は、複数のHTML要素の中からインデックス番号を指定することで特定の要素だけを取得できる。eqの中にaがあるため変数が代入されておりいる状態になる。
